...
enum TestError: ErrorWithMessage {
  ...
  var message: String {
    "Some error textSome error textSome error textSome error textSome error textSome error textSome error textSome error textSome error textSome error textSome error textSome Some error textSome error textSome Some error textSome error textSome Some error textSome error textSome Some error textSome error textSome Some error textSome error textSome Some error textSome error textSome Some error textSome error textSome Some error textSome error textSome "
  }
...
class AVPlayerDemo: UIView, OnRewindSDK.PlayerWrapper {
  ...
  func startPlayback(with streamUrl: URL, at timestamp: TimeInSeconds?) {
    let itemToPlay = AVPlayerItem(url: streamUrl)
